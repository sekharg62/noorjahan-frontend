...
export const checkoutCopy = {
  ...
  paymentOnlineHint: "Pay via mobile banking, then submit your transaction details below.",
  paymentBkash: "bKash",
  paymentNagad: "Nagad",
  paymentRocket: "Rocket",
  paymentOnlineRequired: "Please select bKash, Nagad, or Rocket.",
  paymentDetailsRequired:
    "Please enter your mobile banking number and transaction ID.",
  paymentMethods: {
    bkash: {
      instruction:
        "Please complete your bKash payment at first, then fill up the form below.",
      merchantLabel: "bKash Personal Number",
      senderLabel: "bKash Number",
      transactionLabel: "bKash Transaction ID",
      senderPlaceholder: "01XXXXXXXXX",
      transactionPlaceholder: "e.g. 8N7A2X9KLM",
    },
    nagad: {
      instruction:
        "Please complete your Nagad payment at first, then fill up the form below.",
      merchantLabel: "Nagad Personal Number",
      senderLabel: "Nagad Number",
      transactionLabel: "Nagad Transaction ID",
      senderPlaceholder: "01XXXXXXXXX",
      transactionPlaceholder: "e.g. 74H2K9P1QR",
    },
    rocket: {
      instruction:
        "Please complete your Rocket payment at first, then fill up the form below.",
      merchantLabel: "Rocket Personal Number",
      senderLabel: "Rocket Number",
      transactionLabel: "Rocket Transaction ID",
      senderPlaceholder: "01XXXXXXXXX",
      transactionPlaceholder: "e.g. 12AB34CD56",
    },
  },
  ...
  success: {
    ...
    payOnline: "Paid via mobile banking",
